...
onValue(gps2Ref, (snapshot) => {
  if (snapshot.exists()) {
    ...
    document.querySelector("#sensor-2 .status").textContent = "Active";
    document.querySelector("#sensor-2 .distance").innerHTML = `
    ...
    `;
    document.querySelector("#sensor-2 .temperature").innerHTML = `
